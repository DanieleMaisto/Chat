...
{
    String username, address = "192.168.6.17";
    ...
    {
        String bye = (username + ": :Disconnessione");
        try
        {
            writer.println(bye); 
            writer.flush(); 
        ...
        {
            ta_chat.append("Non hai potuto inviare sei disconesso.\n");
        }
    }
    ...
    public void Disconnect() 
    {
        try 
        {
            ta_chat.append("Disconnesso.\n");
            sock.close();
        } catch(Exception ex) {
            ta_chat.append("Non ti sei disconesso. \n");
        }
        isConnected = false;
    ...
    private void initComponents() {
        ...
        b_disconnect.setText("Disconessione");
        ...
        b_anonymous.setText("Login Anonimop");
    ...
    private void b_connectActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_connectActionPerformed
        if (isConnected == false) 
        {
            ...
            try 
            {
                ...
                writer.println(username + ":è conesso.:Connesso");
                writer.flush(); 
                isConnected = true; 
            } 
            catch (Exception ex) 
            {
                ta_chat.append("Errore nella conessione! Prova Ancora. \n");
                tf_username.setEditable(true);
            }
        ...
        {
            ta_chat.append("Sei già conesso. \n");
        }
    ...
    private void b_anonymousActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_anonymousActionPerformed
        ...
        if (isConnected == false) 
        {
            ...
            try 
            {
                ...
                reader = new BufferedReader(streamreader);
                writer = new PrintWriter(sock.getOutputStream());
                writer.println(anon + ":si è conesso.:Conesso");
                writer.flush(); 
                isConnected = true; 
            } 
            catch (Exception ex) 
            {
                ta_chat.append("Impossibile connettersi! Prova Ancora. \n");
                tf_username.setEditable(true);
            }
        ...
        if ((tf_chat.getText()).equals(nothing)) {
            ...
            try {
               ...
               writer.flush(); // flushes the buffer
                ...
                ta_chat.append("Message non inviato. \n");
            }
            tf_chat.setText("");
            tf_chat.requestFocus();
        }
